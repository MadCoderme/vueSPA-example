...
<template>
    <div class="container">
        ...
        <p class="target-info">
            10 Posts
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style="margin-left: 5px;" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.16" d="M20 5H8V13H20L18 9L20 5Z" fill="#A3F7BF"/>
                <path d="M8 3V5M8 5H20L18 9L20 13H8M8 5V13M8 21V13" stroke="#A3F7BF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </p>
        <meter :value="88" :max="100" style="margin-top: 35px;"></meter>
        <p class="target-info">
            100 Followers
            <svg width="24" height="24" viewBox="0 0 24 24" style="margin-left: 5px;" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.16" d="M20 5H8V13H20L18 9L20 5Z" fill="#A3F7BF"/>
                <path d="M8 3V5M8 5H20L18 9L20 13H8M8 5V13M8 21V13" stroke="#A3F7BF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </p>
