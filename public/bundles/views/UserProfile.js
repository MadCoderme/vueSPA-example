...
const _hoisted_2$2 = createElementVNode("img", {
...
script$1.__file = "src/components/template/SkeletonLoader.vue";const useUsersApi = defineStore('users-api', {
    actions: {
        async getUser(uid) {
            try {
...
}const _withScopeId = n => (pushScopeId("data-v-e928b7d8"), n = n(), popScopeId(), n);
const _hoisted_1 = {
    key: 1,
    class: "container-u"
};
const _hoisted_2 = createStaticVNode("<img src=\"https://images.unsplash.com/photo-1694754933649-8afc9bebc7f2?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=1887&amp;q=80\" loading=\"lazy\" class=\"banner-profile\" data-v-e928b7d8><img src=\"https://images.unsplash.com/photo-1496302662116-35cc4f36df92?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=60\" loading=\"lazy\" class=\"avatar-profile\" data-v-e928b7d8><div class=\"verified-tick\" data-v-e928b7d8><svg width=\"15\" height=\"15\" viewBox=\"0 0 15 15\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" data-v-e928b7d8><path d=\"M10.6077 3.90688C10.4642 3.82703 10.3064 3.77626 10.1433 3.75746C9.98018 3.73865 9.81495 3.75219 9.65706 3.79729C9.49917 3.84239 9.35172 3.91818 9.22314 4.02031C9.09457 4.12244 8.98738 4.24891 8.90772 4.3925L6.5871 8.56875L5.25897 7.24063C5.14366 7.12124 5.00573 7.02601 4.85323 6.9605C4.70072 6.89499 4.5367 6.86051 4.37073 6.85906C4.20475 6.85762 4.04015 6.88925 3.88653 6.9521C3.73291 7.01495 3.59335 7.10777 3.47598 7.22513C3.35861 7.3425 3.2658 7.48206 3.20295 7.63568C3.1401 7.7893 3.10847 7.9539 3.10991 8.11988C3.11135 8.28585 3.14584 8.44988 3.21135 8.60238C3.27686 8.75489 3.37209 8.89282 3.49147 9.00813L5.99147 11.5081C6.22772 11.745 6.54647 11.875 6.87522 11.875L7.04835 11.8625C7.23994 11.8357 7.4227 11.7648 7.58224 11.6554C7.74177 11.5459 7.87373 11.401 7.96772 11.2319L11.0927 5.60688C11.1725 5.46341 11.2233 5.30563 11.2421 5.14255C11.2609 4.97947 11.2474 4.81429 11.2023 4.65642C11.1573 4.49856 11.0816 4.35112 10.9796 4.22251C10.8776 4.0939 10.7512 3.98665 10.6077 3.90688Z\" fill=\"#27323A\" data-v-e928b7d8></path></svg></div>", 3);
const _hoisted_5 = { class: "name-profile" };
const _hoisted_6 = { style: { "font-size": "17px" } };
const _hoisted_7 = { class: "bio" };
const _hoisted_8 = { class: "info-row" };
const _hoisted_9 = _withScopeId(() => createElementVNode("p", null, "Followers", -1));
const _hoisted_10 = _withScopeId(() => createElementVNode("p", null, "Following", -1));
const _hoisted_11 = _withScopeId(() => createElementVNode("p", null, "Posts", -1));
const _hoisted_12 = _withScopeId(() => createElementVNode("div", { class: "btns-row" }, [
    createElementVNode("button", { class: "btn-primary rounded" }, " Follow "),
    createElementVNode("button", { class: "btn-secondary rounded" }, " Message ")
], -1));
const _hoisted_13 = { class: "tab-row" };
const _hoisted_14 = _withScopeId(() => createElementVNode("br", null, null, -1));
...
var script = defineComponent({
    ...
    setup(__props) {
        ...
        onMounted(() => {
            if (route.params.id) {
                api.getUserByUsername(route.params.id)
                    .then((res) => {
                    if (res) {
                        data.value = res;
            ...
            return (openBlock(), createElementBlock(Fragment, null, [
                ...
                (!isLoading.value)
                    ? (openBlock(), createElementBlock("div", _hoisted_1, [
                        _hoisted_2,
                        createElementVNode("h2", _hoisted_5, toDisplayString(data.value.name), 1),
                        createElementVNode("p", _hoisted_6, "@" + toDisplayString(data.value.username), 1),
                        createElementVNode("p", _hoisted_7, toDisplayString(data.value.description), 1),
                        createElementVNode("div", _hoisted_8, [
                            createElementVNode("div", null, [
                                createElementVNode("p", null, toDisplayString(data.value.followerCount), 1),
                                _hoisted_9
                            ]),
                            createElementVNode("div", null, [
                                createElementVNode("p", null, toDisplayString(data.value.followingCount), 1),
                                _hoisted_10
                            ]),
                            createElementVNode("div", null, [
                                createElementVNode("p", null, toDisplayString(data.value.postCount), 1),
                                _hoisted_11
                            ])
                        ]),
                        _hoisted_12,
                        createElementVNode("div", _hoisted_13, [
                            createElementVNode("p", {
                                style: normalizeStyle({ color: currentTab.value == 0 ? 'white' : '#ababab' }),
                                onClick: _cache[0] || (_cache[0] = ($event) => (currentTab.value = 0))
                            }, "Posts", 4),
                            createElementVNode("p", {
                                style: normalizeStyle({ color: currentTab.value == 1 ? 'white' : '#ababab' }),
                                onClick: _cache[1] || (_cache[1] = ($event) => (currentTab.value = 1))
                            }, "Challenges", 4)
                        ]),
                        _hoisted_14,
...
});var css_248z = "\n.container-u[data-v-e928b7d8] {\n    padding: 20px;\n    padding-left: 5%;\n    padding-right: 5%;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-flex-direction: column;\n        -ms-flex-direction: column;\n            flex-direction: column;\n    -webkit-align-items: center;\n        -ms-flex-align: center;\n            align-items: center;\n}\n.name-profile[data-v-e928b7d8] {\n    color: white;\n    font-weight: bold;\n    margin-bottom: -5px;\n    margin-top: 15px;\n}\n.banner-profile[data-v-e928b7d8] {\n    position: absolute;\n    top: 0px;\n    left: 0px;\n    width: 100vw;\n    height: 12%;\n    -o-object-fit: cover;\n       object-fit: cover;\n    -webkit-mask-image: linear-gradient(rgba(255, 255, 255, 1) 15%, rgba(255, 255, 255,0));\n            mask-image: linear-gradient(rgba(255, 255, 255, 1) 15%, rgba(255, 255, 255,0));\n}\n.avatar-profile[data-v-e928b7d8] {\n    width: 85px; \n    height: 85px;\n    border-radius: 50%;\n    -o-object-fit: cover;\n       object-fit: cover;\n    border: 2px solid var(--c-primary);\n    -webkit-align-self: center;\n        -ms-flex-item-align: center;\n            align-self: center;\n    z-index: 10;\n    margin-top: 12%;\n    margin-bottom: 10px;\n}\n.verified-tick[data-v-e928b7d8] {\n    background: var(--c-primary);\n    height: 18px;\n    width: 18px;\n    padding-left: 2px;\n    border-radius: 20px;\n    -webkit-align-self: center;\n        -ms-flex-item-align: center;\n            align-self: center;\n    margin-left: 48px;\n    margin-top: -28px;\n    z-index: 12;\n}\n.bio[data-v-e928b7d8] {\n    color: white; \n    font-size: 17px; \n    margin-top: 10px;\n}\n.info-row[data-v-e928b7d8] {\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-flex-direction: row;\n        -ms-flex-direction: row;\n            flex-direction: row;\n    width: 100%;\n    -webkit-justify-content: space-evenly;\n        -ms-flex-pack: space-evenly;\n            justify-content: space-evenly;\n    margin-top: 20px;\n}\n.info-row > div[data-v-e928b7d8] {\n    color: #ababab;\n    text-align: center;\n}\n.info-row > div > p ~ p[data-v-e928b7d8] {\n    font-size: 16px;\n    color: #ababab;\n    font-weight: normal;\n}\n.info-row > div > p[data-v-e928b7d8] {\n    font-size: 20px;\n    color: white;\n    font-weight: bold;\n}\n.btns-row[data-v-e928b7d8] {\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    width: 100%;\n    margin-top: 20px;\n    margin-bottom: 20px;\n}\n.btns-row > button[data-v-e928b7d8] {\n    width: 50%;\n    margin-inline: 10px;\n}\n.tab-row[data-v-e928b7d8] {\n    -webkit-align-self: flex-start;\n        -ms-flex-item-align: start;\n            align-self: flex-start;\n    display: -webkit-flex;\n    display: -ms-flexbox;\n    display: flex;\n    margin-top: 20px;\n    margin-bottom: 10px;\n}\n.tab-row > p[data-v-e928b7d8] {\n    font-size: 17px;\n    color: white;\n    font-weight: bold;\n    margin-inline: 10px;\n    cursor: pointer;\n}\n@media (max-width: 480px) {\n.bio[data-v-e928b7d8] {\n        font-size: 15px;\n}\n.info-row > div > p ~ p[data-v-e928b7d8] {\n        font-size: 15px;\n}\n.info-row > div > p[data-v-e928b7d8] {\n        font-size: 18px;\n}\n}\n";
styleInject(css_248z);script.__scopeId = "data-v-e928b7d8";
script.__file = "src/views/UserProfile.vue";export{script as default};